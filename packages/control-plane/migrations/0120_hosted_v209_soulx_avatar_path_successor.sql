-- 0120_hosted_v209_soulx_avatar_path_successor.sql
--
...
-- the freshly published Mage image and freshly published SoulX image carrying current source repairs.
-- The published SoulX image still requires fresh GPU qualification; preserve prior live acceptance lineage.
