-- 0114_hosted_v209_54c4b06b_soulx_rebind.sql
--
-- Rebind the SoulX lane to the image built from 54c4b06b, which lets the worker read the
-- prepared span-audio inputs written by the personal media worker's own job. Migration 0113
-- pins the previous digest, and the ledger is append-only, so the constants are superseded here.
--
-- The Mage lane, both retained EU-RO-1 volumes and every model manifest are unchanged, so only
-- the SoulX image identity moves. Every structural check and the rebuilt qualification document
-- are preserved from 0113.
--
--   soulx_avatar image  sha256:047881a3e85fcb98683c2851989ec064628fa803123588ac25929bd6ca6b243a
--                config sha256:d08c7eba4c923db9e524974ff0590fde0f713eae74bec85b5614afc956bfa5cd
--                proof  sha256:16329b6cc8516f28ff4e18136204b2a602debae9ba01c5a432b574a7e18449cc
--                source 54c4b06bd524756ccf83e960ca4a18181de134ce
--
-- Acceptance artifact is the anonymous-pull deployability proof from GitHub Actions run
-- 34443213463, committed under
-- project-context/evidence/acceptance/VF-10-09/2026-09-10-54c4b06b-soulx-prepared-inputs/.
