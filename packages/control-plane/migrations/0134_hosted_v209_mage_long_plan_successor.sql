-- 0134_hosted_v209_mage_long_plan_successor.sql
-- Bind the published Mage long-plan image; preserve SoulX and historical acceptance lineage.
-- Publication proves image identity only. Fresh GPU acceptance remains a separate gate.
-- Rollback restores the function from migration 0120; existing rows are never rewritten.
...
BEGIN
  ...
  FOREACH lane_name IN ARRAY ARRAY['mage_image','soulx_avatar'] LOOP
    ...
    IF lane_name='mage_image' THEN
      ...
      expected_image:='sha256:a74a622400ab21a51f270176ce0df1e7ea292f1ded999abe6193b4c40bb1fde3';
      expected_source:='ad6258ae079762c05434048c76072dd656e378cd';
      expected_config:='sha256:2e2f7cf2fab2d4f36241d0c44955182dddb19e5ebc825524027ef11a872bef97';
      expected_anonymous_proof:='sha256:baf62421dfc739fc0b381e8a9c6f7d8d0bbd598f985bf152aa7e5f7b2885d875';
    ...
    ELSE
      ...
      expected_image:='sha256:f67287feeef2a8ff16efd48d142125f6c3ee1863bde5b92aa74f80b7e741cd35';
      expected_source:='6b80ce1d51e5b6c4f3bd20b7a013e6083577b7a6';
      expected_config:='sha256:316957f7c8e03a2be121fc90aeb0ec4b1cf441e59ffc3582bf0da4052be1627d';
      expected_anonymous_proof:='sha256:39bbecdc664d697270985df89822e98868cfefcb729b9c35e0155233ee54df7a';
