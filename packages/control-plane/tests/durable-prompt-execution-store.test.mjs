...
test("migrations 0009-0016 upgrade live migration-0008 prompt authority and execute", async () => {
  ...
  try {
    ...
    assert.deepEqual(upgraded.appliedVersions, [9, 10, 11, 12, 13, 14, 15, 16]);
