...
const REQUIRED_CUSTOM_INDEXES = [
  ...
  "hosted_prompt_batch_progress_run_idx",
...
const REQUIRED_TRIGGERS = [
  ...
  "hosted_voiceover_contexts_tenant_write_guard",
  "hosted_prompt_batch_progress_tenant_write_guard",
  "hosted_prompt_batch_progress_append_only",
  "hosted_prompt_runs_tenant_write_guard",
  "hosted_style_analysis_runs_tenant_write_guard",
