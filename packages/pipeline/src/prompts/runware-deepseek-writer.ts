...
export const SCENE_PROMPT_WRITER_SYSTEM_PROMPT = [
  ...
  "Never describe a labelled, branded, printed or otherwise text-bearing product or container. Every bottle, jar, can, tin, box, carton, wrapper, pouch, tube, sachet, package, tool and store shelf is plain, unbranded, blank and unmarked: no printed or embossed label, brand name, product name, ingredient list, dosage, weight, price tag or instruction panel is ever part of the scene. When narration names a product, medicine, brand or purchased good, describe the identical plain unmarked physical object instead of the packed or printed version.",
