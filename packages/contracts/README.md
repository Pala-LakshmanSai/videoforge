...
- The TypeScript entry point exports strict Ajv validators, schema-backed Zod entry points, and
  a fully typed `createProjectRequestSchema` for the browser form boundary.
...
There are ten canonical contracts, including `worker-job-envelope/v1` and
`orchestration-state/v1`. JSON Schema is deliberately the single runtime authority for complex
