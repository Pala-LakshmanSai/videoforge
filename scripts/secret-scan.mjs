...
const patterns = [
  ...
  [
    ...
    /\b(?:BETTER_AUTH_SECRET|CLOUDFLARE_API_TOKEN|DATABASE_URL|DEEPSEEK_API_KEY|GOOGLE_CLIENT_SECRET|NEON_DATABASE_URL|R2_ACCESS_KEY_ID|R2_SECRET_ACCESS_KEY|RUNPOD_API_KEY|RUNWARE_API_KEY)[ \t]*=[ \t]*["']?[A-Za-z0-9_:/+.-]{16,}/gu,
  ],
];
