...
class HealthContractTest(unittest.TestCase):
    def test_process_health_never_claims_model_or_spend_readiness(self) -> None:
        ...
        self.assertEqual(health["provider_mode"], "runpod_serverless")
        self.assertFalse(health["synthetic"])
