...
class WorkerHealth(TypedDict):
    ...
    worker_id: Literal["avatar-repair"]
...
def health_payload() -> WorkerHealth:
    """Return a non-secret process health payload without loading MuseTalk."""
    return {
        "schema_version": "worker-health/v1",
        "worker_id": "avatar-repair",
        "process_state": "ready",
        ...
        "capabilities": ["avatar_lip_repair"],
    }
