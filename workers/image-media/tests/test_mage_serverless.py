...
class MageServerlessBoundaryTest(unittest.TestCase):
        ...
        *,
        ...
        return {
            ...
            "input": {
                "envelope": envelope,
                "batch": batch,
                "ports": ports or {"inputs": [], "outputs": [MageServerlessBoundaryTest._port(attempt_id=attempt_id)]},
    ...
    def test_malformed_authority_is_failure_before_runtime_startup(self) -> None:
        ...
        with patch.object(mage_serverless, "_ready_runtime", new=AsyncMock(side_effect=AssertionError)):
    ...
    def test_scoped_port_shape_is_rejected_before_runtime_startup(self) -> None:
        ...
        with (
            ...
            patch.object(mage_serverless, "_ready_runtime", new=AsyncMock(side_effect=AssertionError)) as ready,
        ):
            result = asyncio.run(mage_serverless.handler(job))
    ...
    def test_duplicate_delivery_fails_closed_without_second_runtime_start(self) -> None:
        ...
        with (
            ...
            patch.object(
                mage_serverless,
                "_ready_runtime",
                new=AsyncMock(side_effect=mage_serverless.ServerlessMageError("MAGE_SERVERLESS_NOT_READY")),
            ) as ready,
        ):
