...
1. Sign in.
2. Verify dock keyboard/pointer navigation, scale-only proximity taper, fixed icon bottom edges, reset/no-layout-shift behavior, static active-route backing, reduced-motion neutrality, active route, 1024 px layout, and mobile safe area.
