...
at `fcb8f31`; `VF-4-01` is complete at `1fba04c`; `VF-7-07` has a committed domain foundation but
remains partial.
...
`CURRENT_STATE.yaml` selects only the persistence continuation in `VF-7-07.md`. Complete tasks
