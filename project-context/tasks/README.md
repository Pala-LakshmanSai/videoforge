...
Current implementation checkpoint: `e0bec7e`. `VF-4-01` is complete at `1fba04c`, `VF-4-02` at
`bbb0a48`, `VF-5-01` at `fcb8f31`, `VF-5-02` at `e0bec7e`, and `VF-7-07` at `20fd592`.
...
`CURRENT_STATE.yaml` selects only the versioned Style edit API in `VF-7-08.md`. Complete tasks
