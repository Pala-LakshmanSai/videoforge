...
assert((state.includes("phase: serverless_v2_v2_07_attempt25_closed") || state.includes("phase: serverless_v2_v2_07_attempt26_finalize_transport_repair_candidate_ready")) && state.includes("maximum_external_spend_usd: 0"), "state_phase");
...
assert(gates.includes("latest_closed_proposal: \"" + candidatePath + "\"") && gates.includes("latest_closed_proposal_sha256: \"" + EXPECTED.proposal + "\"") && (gates.includes("authority_mode: none_attempt25_consumed") || gates.includes("authority_mode: none_attempt26_pending_fresh_approval")) && gates.includes("closed_authority: \"evidence/acceptance/VF-10-07/2026-08-21-attempt25-startup-terminal-inventory-candidate/approved-authority.json\"") && gates.includes(EXPECTED.authority) && gates.includes("pending_numeric_cap_usd: null"), "gate_pointer");
...
assert(activation.includes("V207_PENDING_PROPOSAL_SHA256") && (activation.includes(EXPECTED.proposal) || activation.includes("sha256:2d7997db91addfdb8b0449a846ed3d272c2ae6450ebe0834b31f3ceb7bfaba4b")) && activation.includes("V207_APPROVED_FINITE_CAP_USD: number | null = null"), "activation_approved");
