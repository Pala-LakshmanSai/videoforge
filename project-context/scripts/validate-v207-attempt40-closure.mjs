...
for (const [value, code] of [
  ...
  if ((successorCandidate || successorAuthorized) && (code === "GATES" || code === "TASK")) {
...
has(
  gates,
  successorCandidate || successorAuthorized
...
if (!successorAuthorized) has(gates, "pending_authority: null", "GATES");
assert(
