...
assert((preExecution && gates.includes("authority_mode: attempt26_bounded_mutation_authorized") && gates.includes("pending_numeric_cap_usd: 4")) || (closed && gates.includes(`latest_closed_proposal_sha256: \"${EXPECTED.proposal}\"`) && gates.includes(`latest_closed_authority_sha256: \"${EXPECTED.authority}\"`) && gates.includes(`closure_evidence_sha256: \"${EXPECTED.closure26}\"`) && gates.includes("authority_mode: none_attempt26_consumed") && gates.includes("pending_numeric_cap_usd: null")) || (attempt27Candidate && gates.includes("authority_mode: none_attempt27_pending_fresh_approval") && gates.includes('pending_proposal_sha256: "sha256:5cb96aa79a4bb6f1fda3e6dadba7d6997421cc87cd2ed27f6a8ed92bee9fe7ae"') && gates.includes("pending_numeric_cap_usd: null")), "gate_authority_pointer");
