...
for (const value of [expected.proposal, expected.acceptance, expected.authority, expected.max1, expected.max2, expected.priorAuthority, expected.priorClosure, "V207_APPROVED_FINITE_CAP_USD: number | null = 4", "exact_attempt35_single_use_authority_active", "V2-08"]) assert(context.includes(value), `CONTEXT_${value.slice(-8)}`);
process.stdout.write("V2-07 Attempt35 LOW-availability authority validation PASS (single-use; cap USD 4)\n");
