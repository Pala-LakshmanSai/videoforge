...
includesAll(state, ["phase: serverless_v2_v2_07_attempt38_closed_fail_uncertain", "provider_calls_authorized: false", "remote_or_cloud_mutations_authorized: false", "gpu_use_authorized: false", "maximum_external_spend_usd: 0", "v2_07_status: NOT_QUALIFIED_attempt38_closed_fail_uncertain", expected.closure, expected.cleanup, expected.reconciliation, "current_authority: null"], "STATE");
includesAll(gates, ["last_run: \"evidence/acceptance/VF-10-07/2026-08-21-live-qualification/failed-attempt-38.json\"", expected.closure, expected.cleanup, expected.reconciliation, "pending_authority: null", "provider_calls_authorized: false", "gpu_use_authorized: false", "NOT_QUALIFIED_attempt38_cap_arithmetic_stop_cleanup_uncertain"], "GATES");
