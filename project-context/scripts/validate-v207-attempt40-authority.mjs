...
const successor = state.includes("phase: serverless_v2_v2_07_attempt41_candidate_pending_exact_approval");
if (successor) {
...
if (closed) {
  ...
  assert((gates.includes("authority_mode: closed_consumed_attempt40_live_runner_failed") || gates.includes("authority_mode: pending_attempt41_exact_approval_and_fresh_numeric_cap")) && gates.includes("pending_numeric_cap_usd: null") && gates.includes(expected.authority), "GATE_CLOSED_BOUNDARY");
} else {
