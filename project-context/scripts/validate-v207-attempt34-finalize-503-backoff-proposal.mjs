...
for (const value of [expected.successor, expected.control, expected.authority, "sha256:fc173408635e6af48f824188dad878cd6259526f407e655941848f092732ef37", "V207_APPROVED_FINITE_CAP_USD: number | null = null"]) assert(activation.includes(value), `ACTIVATION_${value}`);
