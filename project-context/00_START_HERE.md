...
9.7.1–9.7.6 remain DONE; forward complete-worker repair and source seal are pending.
No current provider authority, mutation permission, or spend cap remains; the new exact successor
approval is pending. 9.7.8 post-import readiness, 9.8 Chrome E2E and 9.9 remain pending.
