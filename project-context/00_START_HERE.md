...
The bounded stage retry audit and stable authenticated download fixes are live at source
`80b4f105` / Cloudflare `37e48c02`, migration 0211. Chrome downloaded the complete MP4 with
the exact accepted checksum. See `china_found_render_and_retry_repair_2026_09_26` in `CURRENT_STATE.yaml`
...
- The user-authorized read-only monitor observed exactly one RTX 4090 and exactly one `EU-RO-1`
  ...
  mutation or spend. Next: independently audit the provider-free dual reconciler URL repair, then
  seal a clean source/bundle and one fresh source-bound proposal for exact approval.
...
- V2-07 is `QUALIFIED_PASS_CLEAN` by Attempt85. Proposal
  ...
  retained-volume mutation, or V2-08 was authorized. Four 32-image batches produced and verified 128
  durable images. Duplicate replay, cancellation, deterministic timeout, and max-two concurrency all
  passed. Generated outputs, disposable Worker/route, endpoint, and template were deleted; three final
  reads prove zero compute and both retained 50 GB volumes unchanged. Billing remained USD
  `2.507309638109291`, with zero observed increment and within cap. Exact redacted evidence and closure:
  `evidence/acceptance/VF-10-07/2026-09-05-attempt85-live-qualification/`; closure SHA-256
  `aeef45f237fd07e0937cdd51eaaf545ac0d8bb4c90eb105708f1681da787cc79`. Attempt85 authority is consumed
  and non-reusable. No V2-08 action occurred.
- Attempt82 is `CONSUMED_FAILED_CLEAN_NON_REUSABLE`. Its provider-free timeout-terminal repair remains
  ...
  P0/P1/P2 `0/0/0`. Two deterministic builds produced pending image
...
- V2-07 Attempt80 is `CONSUMED_FAILED_CLEAN_NON_REUSABLE`. All three pre-GPU cycles and cold/warm
  ...
  timeout and max-two never ran. Generated output rollback removed 96/96 objects.
- Exact standalone cleanup deleted the endpoint and template; Cloudflare control-plane absence plus
  three route `404` reads passed. Three final RunPod reads prove zero pods, endpoints, templates,
...
- Closure `sha256:6ae6b03b0e3e3cdb309da4e123b1ca746745289e407341388b986e9818be5003`, orchestrator
  `sha256:eeba93083e40c83552fc5d3b5204a464b33cb0eaa1042b40f8b6778a4ab0f500`, and reconciliation
  `sha256:5e0134097e0552a53b748db28a1e44fbcace5e865297ae152c0c7ba4610f943e` prove signal-safe cleanup,
...
- Proposal `sha256:2cb0188a05b033b1519101767654cbd2f94e8eed4a10fd353bfeb7483618d0a2` and authority
  `sha256:8b3b6259cfb6dab49fbc7ce0b07d92f51df5c647c72d7ebbbb29cf27b3788c8e` cannot be reused. No
...
- The exact published Mage image from source `51d7de6cb3c0d88ddcb06df533864bf319a1210f` and digest
  ...
  `$7/month` combined. Next: provider-free root-cause repair, focused validation, independent audit,
  and a fresh exact successor proposal; V2-07 remains `NOT_QUALIFIED`.
...
- V2-07 Attempt68 is consumed and closed clean after
  ...
  signer activation, RunPod resource creation, or GPU dispatch. Mandatory three stable RunPod reads
  prove zero Pods/endpoints/templates/workers, `$0` incremental spend, and both exact 50 GB EU-RO-1
  volumes retained. V2-07 remains `NOT_QUALIFIED`; the next provider-free repair must remove the
  shared-Worker rollback-retention dependency. Attempt68 is non-reusable, fresh exact approval is
  required for any successor, and V2-08 remains forbidden.
