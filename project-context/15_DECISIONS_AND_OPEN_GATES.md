...
| `DEC_OUTPUT_003` | Every AI image has a subtle, centered, jitter-free eased zoom-in. The current `ffmpeg-render-v2` envelope is 1.00→1.015/1.02/1.025 for full images and 1.00→1.015 for split-right images. | Avoid static-feeling image clips without calling attention to the effect. This supersedes the earlier 4–8% envelope after the user rejected its visible shake and excessive motion during downloaded-file review on 2026-08-10. |
