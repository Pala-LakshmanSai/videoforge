...
// Attempts69 through 74 were consumed. Attempt75 is approved once under the exact proposal,
// publication, pre-GPU probe, cap, and refresh-disabled boundary below.
