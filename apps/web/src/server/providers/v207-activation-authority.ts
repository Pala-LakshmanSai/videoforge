...
export const V207_PENDING_PROPOSAL_SHA256 =
  "sha256:13acabaed3c21b3a15fcca203072c211f9002057453d4cd9b0fb5a765444d2d4" as const;
// Attempt 21 exact authority is recorded in the candidate evidence. Provider calls remain
// execution-gated by the committed authority record and the exact finite cap below.
