...
describe("V2-07 activation authority", () => {
  it("pins the provider-free Attempt51 lineage with no executable authority", () => {
  ...
  it("rejects Attempt51 inputs before fresh authority", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects Attempt51 even with an unapproved activation", () => {
