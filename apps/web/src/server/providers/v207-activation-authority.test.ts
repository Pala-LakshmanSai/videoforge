...
describe("V2-07 activation authority", () => {
  it("pins the approved single-use Attempt73 proposal and exact cap", () => {
    ...
    expect(V207_PENDING_PROPOSAL_SHA256).toBe(
      "sha256:ebf37567b468afd2788b3ffe83a4b0bd8687040731ee5576dde3bf076e4a0b14",
    );
  ...
  it("accepts only Attempt73 with the exact compiled cap and no anchor refresh", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
  ...
  it("rejects refresh activation without the exact pending Attempt73 proposal", () => {
