...
describe("V2-07 activation authority", () => {
  it("pins the exact approved single-use Attempt77 authority", () => {
    ...
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("20c1fb9eb34b76c860c404705cf7d582350daa17");
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:ca86035ac8c8be8b1cdbe127f3154841f2cccc9007eaa29ae0fb27563dbcf7b1",
    );
  ...
  it("accepts only the exact Attempt77 proposal and finite cap", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
  ...
  it("rejects refresh activation without the exact pending Attempt77 proposal", () => {
