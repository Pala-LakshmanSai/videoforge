...
describe("V2-07 activation authority", () => {
  it("pins the complete Attempt46 lineage with the exact executable authority", () => {
  ...
  it("accepts only the exact Attempt46 authority and cap", () => {
    expect(
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("fails closed on missing or mismatched Attempt46 cap", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("keeps anchor refresh disabled for Attempt46", () => {
