...
describe("V2-07 activation authority", () => {
  it("pins the approved single-use Attempt78 proposal and exact executable boundary", () => {
    ...
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("429ff015eb6502394e042e8c3623608726dce3c4");
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:8b3b6259cfb6dab49fbc7ce0b07d92f51df5c647c72d7ebbbb29cf27b3788c8e",
    );
  ...
  it("accepts only the exact unconsumed Attempt78 authority and cap", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
  ...
  it("rejects refresh activation without the exact pending Attempt78 proposal", () => {
