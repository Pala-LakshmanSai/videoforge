...
describe("V2-07 activation authority", () => {
  it("pins the exact approved Attempt60 proposal and executable authority", () => {
  ...
  it("accepts the exact approved Attempt60 proposal, cap, and refresh activation", () => {
    expect(
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects missing and alternate Attempt60 caps fail-closed", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
