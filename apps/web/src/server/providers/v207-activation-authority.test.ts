...
describe("V2-07 activation authority", () => {
  it("pins the exact approved Attempt61 proposal and executable authority", () => {
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:85640ad57c2048f413e2b63ede9e33548b32a557831e8bab8ca3d1fa483a5769",
    );
  ...
  it("accepts the exact approved Attempt61 proposal, cap, and refresh activation", () => {
    expect(
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects missing and alternate Attempt61 caps fail-closed", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects refresh activation without the exact pending Attempt61 proposal", () => {
