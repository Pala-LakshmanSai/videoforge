...
describe("V2-07 activation authority", () => {
  it("pins the exact Attempt52 single-use executable authority", () => {
    ...
    expect(V207_PENDING_PROPOSAL_SHA256).toBe(
      "sha256:af1c2da86886bc3b4d077a30bf9ab720de6a39aa9fe4e8ec351697df5b224e77",
    );
    expect(V207_HOSTED_PNG_CRC32_REPAIR_COMMIT).toBe("1960ea9307bb7fcb591c842b84fc1c622aec49eb");
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("ec39d091745394f4ebb84362d1c2a9fc1e18b1c3");
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:3b15fca048ba4eb570a27b5a6e6d521a415e27c556c230757b6702e0c1017453",
    );
  ...
  it("requires the exact Attempt52 finite cap", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("accepts exact Attempt52 activation and rejects prior proposal reuse", () => {
