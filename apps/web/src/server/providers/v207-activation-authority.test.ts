...
describe("V2-07 activation authority", () => {
  it("pins the complete approved Attempt50 lineage and exact executable authority", () => {
    ...
    expect(V207_PENDING_PROPOSAL_SHA256).toBe(
      "sha256:1a7dd058e81dc172440a5457db8c5f81ae099dc99c56d3bc36357f1dcd97badb",
    );
    expect(V207_HOSTED_PNG_CRC32_REPAIR_COMMIT).toBe("1960ea9307bb7fcb591c842b84fc1c622aec49eb");
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("9afbdca73b64209899a84555d771a3e7e81f51f6");
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:fea7eaeb0078e88f75f19b5ea811d5af30d0a9d3209604d343fd623f596160a7",
    );
  ...
  it("requires and enforces the exact approved Attempt50 cap", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("returns the exact approved Attempt50 authority with anchor refresh enabled", () => {
