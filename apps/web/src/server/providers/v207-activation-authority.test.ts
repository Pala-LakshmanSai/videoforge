...
describe("V2-07 activation authority", () => {
  it("pins the approved single-use Attempt71 proposal and exact cap", () => {
    ...
    expect(V207_PENDING_PROPOSAL_SHA256).toBe(
      "sha256:5aff2029ba534c34d50e35e6a404e1787572f767b788171e754d9a18a84ae967",
    );
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:94c4e0a7b803916cd16e96ad2b3dda2f6fd745c007d709c2b575db8d89bb4e24",
    );
  ...
  it("accepts only Attempt71 with the exact compiled cap and no anchor refresh", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
  ...
  it("rejects refresh activation without the exact pending Attempt71 proposal", () => {
