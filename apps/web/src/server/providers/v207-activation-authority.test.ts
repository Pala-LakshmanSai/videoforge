...
describe("V2-07 activation authority", () => {
  it("pins the complete consumed Attempt50 lineage with no executable authority", () => {
  ...
  it("rejects former Attempt50 cap inputs after authority consumption", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects consumed Attempt50 even with its former exact activation", () => {
