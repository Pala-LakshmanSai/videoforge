...
describe("V2-07 activation authority", () => {
  it("pins the exact approved single-use Attempt76 authority", () => {
    ...
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("6454405d817fe174b2add1d502a31b241b6a0234");
  ...
  it("accepts only the exact approved Attempt76 cap", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
  ...
  it("rejects refresh activation without the exact pending Attempt76 proposal", () => {
