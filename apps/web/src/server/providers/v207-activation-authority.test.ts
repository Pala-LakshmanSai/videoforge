...
describe("V2-07 activation authority", () => {
  it("pins the approved single-use Attempt70 proposal and exact cap", () => {
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:1a3ee5a67c94e83b208d08b39f3d3a6e506a068901a0f7109da966f8859f046f",
    );
  ...
  it("accepts only Attempt70 with the exact compiled cap and no anchor refresh", () => {
    const exact = {
      V207_IMAGE: image,
      V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
      V207_PROPOSAL_SHA256: V207_PENDING_PROPOSAL_SHA256,
