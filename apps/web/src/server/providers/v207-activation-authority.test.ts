...
describe("V2-07 activation authority", () => {
  it("pins the approved single-use Attempt58 authority", () => {
    ...
    expect(V207_PENDING_PROPOSAL_SHA256).toBe(
      "sha256:7053157f0334d262af094be9f020285c9eabb4fef0c62991ec2f2cc60d705b24",
    );
    expect(V207_HOSTED_PNG_CRC32_REPAIR_COMMIT).toBe("1960ea9307bb7fcb591c842b84fc1c622aec49eb");
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("61919013c74f71995cf1631ce6ac56e633708dce");
    ...
    expect(V207_APPROVED_AUTHORITY_SHA256).toBe(
      "sha256:75a2fa3b793fd5abec02dfa8749aba0cb18a43bdd25a2c6afd03878154b22b66",
    );
  ...
  it("accepts the exact approved Attempt58 proposal, cap, and refresh activation", () => {
    expect(
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects missing and mismatched Attempt58 finite caps fail-closed", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects refresh activation without the exact approved Attempt58 proposal", () => {
