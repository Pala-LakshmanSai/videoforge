...
describe("V2-07 activation authority", () => {
  it("pins the complete Attempt25 startup-terminal-inventory candidate lineage", () => {
  ...
  it("accepts the exact Attempt25 proposal under the recorded fresh cap", () => {
    expect(
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
  ...
  it("rejects a cap different from the exact Attempt25 authority", () => {
    expect(() =>
      parseV207ActivationAuthority({
        V207_IMAGE: image,
        V207_IMAGE_SOURCE_COMMIT: V207_REPAIRED_IMAGE_SOURCE_COMMIT,
