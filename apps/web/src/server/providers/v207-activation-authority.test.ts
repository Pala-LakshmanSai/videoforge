...
describe("V2-07 activation authority", () => {
  it("pins the complete provider-free Attempt38 durable replacement lineage", () => {
    ...
    expect(V207_PENDING_CONTROL_SOURCE_COMMIT).toBe("edb18154759a1c4da9f28789fe5f4c4ab74a92ed");
