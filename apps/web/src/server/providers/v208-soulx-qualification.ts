...
// The single-use Stage 7 authority was consumed by a billing-baseline admission drift before any
// provider or R2 mutation. Fresh exact source-bound approval is required.
