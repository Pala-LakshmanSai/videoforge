...
// Exact single-use authority materialized from the approved builder-rebind proposal. The launcher
// requires this clean one-parent successor and fails closed outside it.
export const V208_PENDING_PROPOSAL_SHA256: string | null =
  "sha256:6d7df20805361ddb552f438cc89327598a0db907e174024d8c0928748bf5e106";
export const V208_COMPILED_AUTHORITY_ACTIVE: boolean = true;
export const V208_APPROVED_CONTROL_SOURCE_COMMIT: string | null =
  "a5e116d025b98505c1b53d80ec8f25a7b12ecaa2";
export const V208_APPROVED_AUTHORITY_SHA256: string | null =
  "sha256:0b19b5f5433b22ccc444afd53e83efa78f15974cb857a2d96adef067ae05d1cc";
...
export const V208_APPROVED_IMAGE_SOURCE_COMMIT: string | null =
  "0d32b1c3d36610f6a41d9b413628164d47f490d0";
