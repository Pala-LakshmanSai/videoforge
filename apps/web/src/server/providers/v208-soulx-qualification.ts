...
// Exact single-use authority materialized from the fresh approved repaired proposal. The launcher
// still requires a clean one-parent allowlisted successor and fails closed outside this binding.
export const V208_PENDING_PROPOSAL_SHA256: string | null =
  "sha256:fbd5acf14dcd891b3468c9c74d9570652415d96819b915168171767b9d80c440";
export const V208_COMPILED_AUTHORITY_ACTIVE: boolean = true;
export const V208_APPROVED_CONTROL_SOURCE_COMMIT: string | null =
  "7ad0cd2aeb53b4925d02cca0ff263a5d3a473591";
export const V208_APPROVED_AUTHORITY_SHA256: string | null =
  "sha256:ffe23bacc1ab05c042ea9638dd6616cdc377832fe1e0bdd08f039534cc0ec37e";
