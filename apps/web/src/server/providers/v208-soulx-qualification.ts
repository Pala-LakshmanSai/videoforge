...
// The a4ff single-use authority is consumed by the failed pre-POST guard attempt. A repaired
// source may be proposed provider-free, but remains inert until a new exact approval is bound.
