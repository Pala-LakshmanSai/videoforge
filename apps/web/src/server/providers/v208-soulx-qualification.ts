...
// The 4d4b7cff single-use authority is consumed. Keep execution fail-closed until a separately
// hashed worker-image repair proposal receives fresh exact approval and is materialized.
