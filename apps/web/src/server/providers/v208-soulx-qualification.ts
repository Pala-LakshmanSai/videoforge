...
// The repaired-image authority was consumed by a fail-closed exact billing-baseline drift before
// any RunPod job POST. A fresh exact proposal and approval are required for paid execution.
