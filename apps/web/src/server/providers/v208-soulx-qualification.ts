...
// The 9e5d4eb9 single-use authority passed qualification and is consumed. Execution is disabled;
// the immutable image and closure remain evidence only and cannot be replayed.
