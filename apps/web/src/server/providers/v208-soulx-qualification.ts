...
// The single-use Stage 7 authority was consumed by an exact-offering admission miss before any
// provider mutation or dispatch. Fresh exact source-bound approval is required.
