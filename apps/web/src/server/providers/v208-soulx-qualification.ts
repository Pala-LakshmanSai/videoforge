...
// The volume-manifest-repair authority was consumed by the required provider-free pre-dispatch
// audit. A fresh exact proposal is required before any provider mutation or paid execution.
