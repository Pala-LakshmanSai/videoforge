...
// The queue-plus-execution authority was consumed by the cleaned receipt-nonce replay failure. A
// fresh exact proposal, repaired immutable image, and approval are required before paid execution.
