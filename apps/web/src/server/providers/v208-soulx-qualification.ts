...
// The single-use Stage 7 authority was consumed by a second billing-baseline drift before any
// provider or R2 mutation. Fresh exact source-bound approval and sufficient cap are required.
