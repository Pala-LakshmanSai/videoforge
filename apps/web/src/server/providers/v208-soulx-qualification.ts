...
// The builder-rebind authority was consumed by the cleaned media-contract attempt. A fresh exact
// proposal and approval are required before publication, provider mutation, or paid execution.
