...
def main() -> int:
    ...
    if not re.fullmatch(r"sha256:[0-9a-f]{64}", args.whisper_model_sha256):
        raise SystemExit("whisper model SHA-256 must be exact lowercase prefixed hex")
    value = {
        ...
        "whisper_model_sha256": args.whisper_model_sha256,
