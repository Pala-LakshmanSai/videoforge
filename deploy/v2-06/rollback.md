...
3. Restore the previously recorded Cloudflare Worker version and prior immutable desktop
...
6. Record Cloudflare Worker version, desktop release/checksums/trust identities, migration hash, R2
