...
- Rollback deploys the previously recorded Worker version and job manifests. Schema migration 0029
  is additive and retained. Staging objects are deleted only through tenant retention records after
