...
GRANT EXECUTE ON FUNCTION public.videoforge_record_v213_stage_authority(uuid,jsonb),
  ...
  public.videoforge_record_v213_disabled_promotion_closure(uuid,jsonb),
  ...
  public.videoforge_claim_v213_cleanup_receipt_intent(jsonb),
...
expected_functions(oid,signature) AS (VALUES
  ...
  ('public.videoforge_record_v213_disabled_promotion_closure(uuid,jsonb)'::regprocedure::oid,'videoforge_record_v213_disabled_promotion_closure(uuid,jsonb)'),
