...
export const MAGE_QUALIFICATION_SHA256 =
  "sha256:c28a0fc82b5b36f75952a4860214aff25364d37ed4c461ba1b90a0e7c6fa641e";
...
export function validateReleaseManifest(bytes, expectedSha256) {
  ...
  if (
    !["0.1.17", "0.1.18", "0.1.19", "0.1.20", "0.1.21", "0.1.22", "0.1.23", "0.1.24"].includes(manifest.version) ||
    !manifest.windows.url.includes(`/media-worker-v${manifest.version}/`) ||
    !manifest.macos.url.includes(`/media-worker-v${manifest.version}/`)
  )
    fail("media worker release is not an admitted immutable version");
...
export function validateQualifiedRenderedConfig(config, binding, releaseManifest) {
  ...
  if (
    !["0.1.17", "0.1.18", "0.1.19", "0.1.20", "0.1.21", "0.1.22", "0.1.23", "0.1.24"].includes(releaseManifest.version) ||
