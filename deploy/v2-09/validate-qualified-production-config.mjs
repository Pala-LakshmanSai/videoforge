...
export function validateReleaseManifest(bytes, expectedSha256) {
  ...
  if (
    !["0.1.17", "0.1.18", "0.1.19", "0.1.20", "0.1.21", "0.1.22", "0.1.23"].includes(manifest.version) ||
...
export function validateQualifiedRenderedConfig(config, binding, releaseManifest) {
  ...
  if (
    !["0.1.17", "0.1.18", "0.1.19", "0.1.20", "0.1.21", "0.1.22", "0.1.23"].includes(releaseManifest.version) ||
